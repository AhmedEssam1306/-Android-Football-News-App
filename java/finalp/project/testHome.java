...
public class testHome extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tb  = (TableLayout) findViewById(R.id.eplT);
        tb1 = (TableLayout) findViewById(R.id.ligaT);
        ParseQuery<ParseObject> query = ParseQuery.getQuery("homepage");
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if (e == null) {
                    ...
                    for (int i=0; i<objects.size(); ++i) {
                        Log.d("tag", "Team: " + objects.get(i).getString("firstTeam") + " " + objects.get(i).getString("secondTeam") + " ");
                        ...
                        tv1.setText(objects.get(i).getString("firstTeam") + "\t");
                        tv2.setText(objects.get(i).getString("secondTeam") + "\t");
                        tv3.setText(objects.get(i).getString("time") + "\t");
                        tv10.setText("  ");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_test_home, menu);
        return true;
    }
